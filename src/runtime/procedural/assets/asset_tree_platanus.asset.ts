 ...
 *      [1][3][7][8][9]——L5 簇位 0.22 承载率 × 85% 成对，正二十面体 20 面/球 flat +
 *      每球 3 面 ≈3mm 细梗（26 三角/球——首球梗回簇心、成对第二球梗自首球球心侧向
 *      连出，端点内埋破「无梗悬浮」读向；球心散列姿态去克隆）、径 ≈5–6.4cm
 *      （真径 2.5cm ×2 工程映射）、长梗下垂叶幕下；**账目入皮组（组 0）**：果序顶点 uv
 ...
 *      （2026-09-20 探针，规范种子；果序口径 2026-09-23 更新为 26 三角/球含梗）：
 *      High 总面 29004–31064（slot-6 疏松最低 /
 *      slot-7 丰满最高；叶卡 1295–1752 ×2 + 果序 2184–3406（84–131 球 ×26——球 20 +
 *      梗 6）、保留簇
 *      371–447）、Mid 总面 7756–9308（叶卡 503–702 ≈ High 存活卡 × 0.40——疏簇
...
export const meta: ProceduralAssetMeta = {
  ...
  triangleCount: 30536, // 实数 = slot-0 锚点 High 档结构计数（皮 24178 恒定 + 疏簇叶卡 1684×2 + 果序 115 球×26（球 20 + 梗 6）；多档起声明面取细模档；见模块头预算锁定账目）
