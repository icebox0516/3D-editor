 ...
 *      向量组合的原料（八槽完整组合见下方 TREE3A_SHAPE_PROFILES——slot-0 锚点 +
 *      七组差量展开）。
 ...
 */
const TREE3A_SLOT1_PROFILE: Tree3aShapeProfile = {
 ...
 */
const TREE3A_SLOT2_PROFILE: Tree3aShapeProfile = {
  ...TREE3A_SLOT0_PROFILE,
  crownWidthRatio: 0.7,
 ...
 */
const TREE3A_SLOT3_PROFILE: Tree3aShapeProfile = {
  ...TREE3A_SLOT0_PROFILE,
 ...
 * 冠幅比微升（0.72）。
 */
const TREE3A_SLOT4_PROFILE: Tree3aShapeProfile = {
  ...TREE3A_SLOT0_PROFILE,
 ...
 */
const TREE3A_SLOT5_PROFILE: Tree3aShapeProfile = {
  ...TREE3A_SLOT0_PROFILE,
 ...
 */
const TREE3A_SLOT6_PROFILE: Tree3aShapeProfile = {
  ...TREE3A_SLOT0_PROFILE,
  canopyDensity: 0.7,
 ...
 */
const TREE3A_SLOT7_PROFILE: Tree3aShapeProfile = {
  ...TREE3A_SLOT0_PROFILE,
 ...
 * 20724 与 rng 消费次数恒等的结构性保证）；morphSeed 路由见 asset_tree_3a.asset。
 */
export const TREE3A_SHAPE_PROFILES: Tree3aShapeProfile[] = [
  TREE3A_SLOT0_PROFILE,
