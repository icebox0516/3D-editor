...
- [~] T006.6 LOD 选档稳定基准（in-progress 2026-09-20，**D28 收官后追加**——不重开 006.5 验收门：选档基准从「当前档位几何球」演进为「High 档派生稳定半径」，剔除不跟随；Step 1 测试先行 done 2026-09-20，Step 2 实装 + Step 3 A/B 重锁判定排 T011 族建设后）→ [006.6-lod-reference-bounds.md](006.6-lod-reference-bounds.md)
