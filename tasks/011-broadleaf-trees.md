...
> 立项：2026-09-19（TASKS.md 占位转正）。前置：T010 5/5 收官（启动条件确认见 010.5——SOP 六步 + asset-research 技能 + Spec 模板 + 家族契约与预算行 + taxonomy broadleaf 就绪）、T006 5/5 收官（Runtime LOD 调度就绪，族建设放量前调度已验收）。**状态：进行中（1/5，011.1 done 2026-09-20）**。
