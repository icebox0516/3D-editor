...
> 立项 2026-09-19（初版「第一批四树种」）；2026-09-20 D33 口径改版为开放式集合——规则面向「本 Epic 纳入的树种」表述、不写死数量。前置：T010 5/5 收官（启动条件确认见 010.5）、T006 5/5 收官（Runtime LOD 调度就绪）。**状态：进行中——成员 12 树种：12 done（011.12 垂柳 done 2026-09-23，垂枝域应力位①档实证），生产收官；族级验收门 011.13 进行中（缺口清单输入齐备，见各任务书完成记录）。**
>
...
| 12 | 垂柳 salix | 011.12 | `asset_tree_salix` | `docs/research/salix-reference.md` | done 2026-09-23 |
...
- [x] T011.12 垂柳全链（done 2026-09-23：垂枝域应力位①档实证〔upturn 强负链+喷泉骨架+簇沿切向，家族契约零触碰〕+ 狭披针细叶 SDF + 树皮第 13 语言 + Low 单竖卡分化；零校准轮〔密度定量 A/B 闭合〕）→ [011.12-salix.md](011.12-salix.md)
- [x] T011.13 T011 族级验收门（done 2026-09-23：七项全过——横向一致性/真实差异/混植/预算全表/性能 13×5〔1000 棵最低 396 FPS=阈值 13×〕/契约零修订〔10 主题裁定、envMap 缺口 B 转 T018〕/回归 3918；族门方法首跑提案待用户确认升格）→ [011.13-acceptance.md](011.13-acceptance.md)
