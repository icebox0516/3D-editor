...
- [x] 021.5 Shadow Representation（done 2026-09-24：ShadowPolicy 三字段策略层 + depth 三档映射〔low 不挂 SDF〕/ 两链策略驱动 + 合并桶 OR / 中点切换钩子接通〔连续派生〕/ culled 零残影，4160 全绿）→ [021.5-shadow-representation.md](021.5-shadow-representation.md)
