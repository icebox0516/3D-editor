...
- [ ] T009 夏栎结构真实性与生产化（2/7；2026-09-18 解锁）→ [tasks/009-tree-realism.md](tasks/009-tree-realism.md)
  ...
  - [ ] T009.3 8 槽形态向量表（下一个：**逐槽用户裁定门**——参考基调异议可在此打回）→ [tasks/009.3-shape-slots.md](tasks/009.3-shape-slots.md)
