...
- [ ] T009 夏栎结构真实性与生产化（3/7；2026-09-18 解锁）→ [tasks/009-tree-realism.md](tasks/009-tree-realism.md)
  ...
  - [x] T009.3 8 槽形态向量表（done 2026-09-18：8 组 shapeProfile 差量展开 + mountSlots 批量出图面；用户裁定门两轮 8/8 通过定稿零微调；+14 测试 → 2473 全绿；取证 `docs/acceptance/t009/009.3/`）→ [tasks/009.3-shape-slots.md](tasks/009.3-shape-slots.md)
  - [ ] T009.4 树皮近景微起伏（下一个）→ [tasks/009.4-bark-relief.md](tasks/009.4-bark-relief.md)
