...
- [ ] T008 程序化树木（2/6；2026-09-17 grill 拷问门过立顶，D19 落档；2026-09-18 植物资产路线 grill → D20：新增 008.6、008.5 修订为收官门后置于 T009；**008.3 尾锚点定调 = 唯一人工阻断门**）→ [tasks/008-procedural-tree.md](tasks/008-procedural-tree.md)
  ...
  - [ ] T008.6 夏栎视觉参考研究（T009 前置；2026-09-18 新增，D20）→ [tasks/008.6-plant-reference.md](tasks/008.6-plant-reference.md)
...
- [ ] T009 夏栎结构真实性与生产化（0/7；前置 T008.6；2026-09-18 立项 → D20；009.5 可与 009.1–009.4 并行）→ [tasks/009-tree-realism.md](tasks/009-tree-realism.md)
...
> 子任务依赖速查：T002 内 002.1→002.2→002.3 刚性，002.4 仅依赖 002.1，002.5 依赖全部；T003 内 003.1/003.2 仅依赖 002.1，003.3 依赖 003.1+003.2，003.4 仅依赖 002.1，003.5 依赖 003.3+003.4；T008 内 008.1→008.2→008.3→【锚点人工门】→008.4→008.6→（T009 全部）→008.5 收官门（2026-09-18 修订，D20）；T009 内 009.1→009.2→009.3→009.4→009.6→009.7、009.5 可并行（009.3→009.4 为同文件串行非功能依赖）；T010 前置 T009+008.5，内 010.1→010.2→（010.3∥010.4）→010.5；T011–T016 前置 T010，T017 前置 T016。各 epic 验收门（x.x.N 末位）依赖本 epic 全部内容子任务。grill 拷问门：T002.1 开工前、T003.3 开工前、T008 开工前（2026-09-17 已过 → D19）、T007 启动前（议题见各自任务书）；T009/T010 立项门由 2026-09-18 植物资产路线 grill 记录充任（→ D20）；T016/T017 启动前各过独立拷问门（D21）。
