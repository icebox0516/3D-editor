...
- [~] T011 阔叶乔木族生产任务集合（D33 开放式集合；成员 12 树种：10 done〔朴/樟/榉/银杏/悬铃木/栾/乌桕/重阳木/国槐/白蜡，2026-09-20~22，每树完成详情见各任务书完成记录〕/ 2 排产〔011.11 女贞 → 011.12 垂柳〕，族门 011.13 未启动；标准模式逐树推进 D35.1；测试基线 3689 / 566 / typecheck 零错）→ [tasks/011-broadleaf-trees.md](tasks/011-broadleaf-trees.md)
